...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void recibeDatos(int idEmp,String nombre,String apellidos,String tipoDoc, String documento, String correo){
        System.out.println("IdEmp" + idEmp + "Nombre " + nombre + " " + apellidos + "Docuemento " + tipoDoc + " " + documento + "Correo " + correo);
    ...
    public void ActulizarEmpleado(){
        //Consultmaos el valor que contiene el TEXTO y lo asignamos a una variable
        int idEmp = Integer.parseInt(txtId.getText());
        String nombre = txtNombre.getText();
        String apellidos = txtApellidos.getText();
        String correo = txtCorreo.getText();
        //Campo editable nombre apellido y correo 
        if (nombre.isEmpty()){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,"El Usuario ha Sido Actulizado ");
