...
public class AddUserFrom extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/img2.png"))); // NOI18N
    ...
    private void btguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btguardarActionPerformed
        ...
        if (nombre.isEmpty() || apellidos.isEmpty() || documento.isEmpty() || email.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Faltan Campos Por Diligenciar", "Formulario registro", JOptionPane.WARNING_MESSAGE);
        } else {
